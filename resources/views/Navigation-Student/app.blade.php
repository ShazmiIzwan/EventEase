		...
		<div class="header-inner">
			<nav class="navbar navbar-expand-lg bg-barren barren-head navbar fixed-top justify-content-sm-start pt-0 pb-0">
				<div class="container">	
					...
					<a class="navbar-brand order-1 order-lg-0 ml-lg-0 ml-2 me-auto" href="/student-home">
						<div class="res-main-logo">
							<img src="images/logo-icon.svg" alt="">
						</div>
						<div class="main-logo" id="logo">
							<img  src="{{ asset('event-management.png') }}"  style="width:40px; height:40px;" alt=""> <span style="color:black;"> EventEase</span>
							<img class="logo-inverse"  src="{{ asset('event-management.png') }}"  style="width:40px; height:40px;" alt=""> 
						</div>
					</a>
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
						...
						<div class="offcanvas-body">
							...
							<ul class="navbar-nav justify-content-end flex-grow-1 pe_5">
								<li class="nav-item">
									<a class="nav-link <?php if($page == 'home') { echo 'active'; } ?>" aria-current="page" href="/student-home">Home</a>
								</li>
                                <li class="nav-item">
									<a class="nav-link <?php if($page == 'events') { echo 'active'; } ?> " aria-current="page" href="/events">Explore Events</a>
								</li>
								<li class="nav-item">
									<a class="nav-link <?php if($page == 'myreg') { echo 'active'; } ?>" href="/myreg">My Registration</a>
								</li>
