		...
		<div class="header-inner">		
			<nav class="navbar navbar-expand-lg bg-barren barren-head navbar fixed-top justify-content-sm-start pt-0 pb-0 ps-lg-0 pe-2">
				<div class="container-fluid ps-0">
					...
					<a class="navbar-brand order-1 order-lg-0 ml-lg-0 ml-2 me-auto" href="/home-admin">
	...
	<nav class="vertical_nav">
		<div class="left_section menu_left" id="js-menu">
			<div class="left_section">
				...
				<li class="menu--item">
  <a href="/home-admin"
     class="menu--link <?php if($page=='dashboard') echo 'active'; ?>"
...
<li class="menu--item">
  <a href="/users"
     class="menu--link <?php if($page=='users') echo 'active'; ?>"
